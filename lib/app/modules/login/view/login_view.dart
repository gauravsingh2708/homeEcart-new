                        ...
                        Container(
                          ...
                          decoration: const BoxDecoration(
                              ...
                              image: DecorationImage(
                                image: AssetImage(
                                    'assets/img/login_background.jpeg'),
                                fit: BoxFit.fill,
                              )),
                        ),
                        SizedBox(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Price Your Can Trust',
                                style: Styles.black18
                                    .copyWith(fontWeight: FontWeight.w600),
                              ),
                              Text(
                                'Quick-Affordable-Trusted',
                                style: Styles.grey14.copyWith(fontSize: 10),
                              ),
                              const SizedBox(
                                height: 20,
                              ),
                              ...
                              _controller.showLoginButton
                                  ? InkWell(
                                      onTap: () async {
                                        await _controller.loginWithPhoneNumber(
                                            _controller.number);
                                      },
